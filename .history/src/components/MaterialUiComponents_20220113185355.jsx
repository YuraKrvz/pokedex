...
export function MediaCard({name, url}) {
  ...
  return (
     <Link to={`${name}`} style={{textDecoration: 'none'}} >
        <Card sx={{ width: 300, height: '350px', margin: '10px', backgroundColor: `${pokemon && colors[`${pokemon.types[0].type.name}`]}` }}>
           <CardMedia
           ...
           />
           <CardContent>
              <Typography gutterBottom variant="h5" component="div" style={{ textTransform:}}>
                 {name}
              </Typography>
